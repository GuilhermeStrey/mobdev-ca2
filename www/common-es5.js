...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        key: "getEpisodes",
        value: function getEpisodes(offset) {
        ...
        value: function getCharacters(offset) {
          return this.http.get("https://breakingbadapi.com/api/characters?limit=100&offset=".concat(offset));
        }
      }, {
        key: "getCharacter",
        ...
        key: "getQuotes",
        value: function getQuotes(offset) {
        ...
        key: "getDeaths",
        value: function getDeaths(offset) {
          return this.http.get("https://breakingbadapi.com/api/deaths");
        }
      }, {
        key: "findEpisode",
        value: function findEpisode(search) {
          return this.http.get("https://breakingbadapi.com/api/episodes/".concat(search));
        }
      }]);
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY = 'favoriteEpisodes';
    var STORAGE2_KEY = 'favoriteCharacters';
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        ...
        key: "isFavouriteEpisode",
        value: function isFavouriteEpisode(episodeId) {
        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(STORAGE2_KEY, result);
            } else {
              return _this3.storage.set(STORAGE2_KEY, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE2_KEY, result);
            }
          });
        }
      }]);
